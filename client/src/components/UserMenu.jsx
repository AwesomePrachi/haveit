  ...
  return (
    <div>
        ...
        <div className='text-sm flex items-center gap-2'>
          ...
          <Link onClick={handleClose} to={"/dashboard/profile"} className='hover:text-yellowish'>
        ...
        <div className='text-sm grid gap-1'>
            ...
            <Link onClick={handleClose} to={"/dashboard/address"} className='px-2 hover:bg-orange-200 py-1'>Saved Addresses</Link>
