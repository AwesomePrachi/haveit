    ...
    const handleSubmitSubCategory = async(e)=> {
        ...
        try {
            ...
            if (responseData.success) {
                ...
                dispatch(setAllSubCategories(refetchData.data));
                }
            ...
            <form className='my-3 grid gap-3' onSubmit={handleSubmitSubCategory}>
                    ...
                    <div className='grid gap-1'>
                        <label>Category</label>
                            ...
                            {/*select category**/}
                            <select
                                className='w-full p-2 bg-transparent outline-none border text-neutral-600'
                                onChange={(e)=>{
                        ...
                        <div className='flex flex-wrap gap-2'>
                            {
                                subCategoryData.category.map((cat,index)=>{
                                    return(
                                        <div key={cat._id+"selectedValue"} className='bg-white shadow-md text-sm flex items-center gap-1 mt-2 mb-3 px-1'>
                                            {cat.name}
