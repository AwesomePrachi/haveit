...
const EditProductAdmin = ({close, data: propsData, fetchProductData}) => {
  ...
  const handleSubmitField = () => {
    setData((prev) => {
      return {
        ...prev,
        more_details: { ...prev.more_details, [newFieldName]: "" }
      }
    })
    setNewFieldName("")
  ...
  return (
    <section className='fixed inset-0 bg-neutral-600/60 z-50 p-4'>
        ...
        <section className=''>
          ...
          <div className='grid p-3'>
            <form className='grid gap-4' onSubmit={handleSubmit}>
              ...
              <div onClick={() => setIsAddFieldOpen(true)} className='bg-purple-600 border border-purple-800 text-white hover:bg-white hover:text-neutral-900 py-1 px-3 mt-2 mb-2 w-32 text-center font-semibold cursor-pointer rounded'>
                Add Fields
              </div>
